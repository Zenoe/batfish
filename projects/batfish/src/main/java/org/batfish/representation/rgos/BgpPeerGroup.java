...
public abstract class BgpPeerGroup implements Serializable {
  ...
  protected final BgpPeerGroup getParentGroup(BgpProcess proc, RgosConfiguration cv) {
  ...
  protected final BgpPeerGroup getParentSession(BgpProcess proc, RgosConfiguration cv) {
    BgpPeerGroup parent = null;
  ...
  public void inheritUnsetFields(BgpProcess proc, RgosConfiguration cv) {
    // TODO: We are not enforcing any inheritance depths limits, e.g., seven for peer-session
    // templates---https://www.rgos.com/c/en/us/td/docs/switches/lan/catalyst3850/software/release/16-11/configuration_guide/rtng/b_1611_rtng_3850_cg/configuring_bgp.html#task_pmr_wsb_fhb
    if (_inherited) {
      return;
    }
    _inherited = true;

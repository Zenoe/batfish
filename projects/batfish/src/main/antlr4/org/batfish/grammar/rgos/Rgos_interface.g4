...
if_ip_ospf_area
:
   OSPF procname = variable AREA area_ip = variable NEWLINE
;
...
:
  ADDRESS
  (
    address = IPV6_ADDRESS (len = ipv6_interface_address_length)
    | prefix = IPV6_PREFIX
  ) NEWLINE
;
